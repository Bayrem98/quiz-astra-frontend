      ...
      >
        ...
        >
          ...
          <CardBody>
            ...
            propose des questions sur les signes du zodiaque, les planètes, les
            maisons astrologiques, les transits, etc. La deuxième catégorie,
            <span className="animated-gradient-text1">"Numérologie"</span>, vous
            invite à découvrir les secrets des nombres, des cycles de vie, des
            nombres de destinée, des nombres karmiques, etc. La troisième
            catégorie,{" "}
            <span className="animated-gradient-text2">"Tarologie"</span>, vous
            offre des questions sur les arcanes majeurs et mineurs du tarot, les
            différentes méthodes de tirage, les significations symboliques, etc.
            Enfin, la catégorie{" "}
            <span className="animated-gradient-text3">"Culture Générale"</span>,
            vous permet de tester vos connaissances sur divers sujets tels que
